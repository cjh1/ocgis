...
class TestAbstractHarvestDataset(TestBase):
    ...
    def test_container(self):
        ...
        try:
            ...
            to_test.pop('dataset')
            self.assertDictEqual(to_test,{'spatial_res': 2.8125, 'time_start': datetime.datetime(2001, 1, 1, 0, 0), 'spatial_abstraction': 'polygon', 'spatial_proj4': '+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_defs ', 'time_res_days': 1.0, 'time_units': u'days since 1850-1-1', 'time_stop': datetime.datetime(2011, 1, 1, 0, 0), 'time_calendar': u'365_day', 'field_shape': '(1, 3650, 1, 64, 128)', 'spatial_envelope': 'POLYGON ((-1.4062500000000000 -90.0000000000000000, -1.4062500000000000 90.0000000000000000, 358.5937500000000000 90.0000000000000000, 358.5937500000000000 -90.0000000000000000, -1.4062500000000000 -90.0000000000000000))', 'uri': '/usr/local/climate_data/CanCM4/tas_day_CanCM4_decadal2000_r2i1p1_20010101-20101231.nc'})
